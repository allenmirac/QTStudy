...
//新用户增加
void Server::serverUIAddUser_Slots(QString userComputerName, QString userComputerIP, QString userAccount, QString userName)
{
    //在表格显示用户信息
...
//用户退出聊天室
void Server::serverUIDeleteUser_Slots(QString userAccount)
{
    //在表格删除退出用户
...
//聊天信息
void Server::serverUIChatMessage_Slots(QString message)
{
...
void Server::closeEvent(QCloseEvent * event)
{
    ...
    button = QMessageBox::question(this, "退出程序", QString("确认退出服务器？"), QMessageBox::Yes | QMessageBox::No);
